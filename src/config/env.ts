...
const envSchema = z.object({
  ...
  TURN_ENGINE_VERSION: z.enum(["legacy", "v3"]).default("legacy"),
  TURN_PERSISTENCE_MODE: z.enum(["memory", "postgres"]).default("memory"),
  OPERATIONAL_STORE_MODE: z.enum(["runtime-json", "postgres"]).default("runtime-json"),
  TURN_TRACE_INCLUDE_TEXT: envBooleanDefault(false),
  ...
  DASHBOARD_OPERATOR_PASSWORD: z.string().optional(),
