...
const envSchema = z.object({
  ...
  TELEGRAM_MESSAGE_DEBOUNCE_MS: z.coerce.number().int().nonnegative().default(900),
  TELEGRAM_REPLY_GRACE_MS: z.coerce.number().int().nonnegative().default(250),
  TELEGRAM_MESSAGE_BATCH_SIZE: z.coerce.number().int().positive().max(10).default(5),
